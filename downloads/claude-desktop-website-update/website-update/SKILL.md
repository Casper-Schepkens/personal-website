...
JSON volgens `references/update-spec.md` (version 1, summary, changes[]). Regels:
...
Zie ook `references/update-examples.md` en `references/content-schema.md`.
...
**Gebruik geen API of MCP** — alleen GitHub issues + `@cursor`.
...
- `references/github-workflow.md` — setup en troubleshooting
